...
public class DeviceProfile {
    ...
    //Service UUID to expose our characteristics
    ...
    public static UUID CHARACTERISTIC_TEMPERATURE_UUID = UUID.fromString("275348FB-C14D-4FD5-B434-7C3F351DEA5F");
    //Read-write characteristic for number
    public static UUID CHARACTERISTIC_NUMBER_UUID = UUID.fromString("BD28E457-4026-4270-A99F-F9BC20182E15");
