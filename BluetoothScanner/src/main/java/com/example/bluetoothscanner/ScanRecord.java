...
public final class ScanRecord {
    ...
    public String toString() {
        return "ScanRecord [mAdvertiseFlags=" + mAdvertiseFlags + ", mServiceUuids=" + mServiceUuids
                + ", mManufacturerSpecificData=" + sparseArrayToString(mManufacturerSpecificData)
                + ", mServiceData=" + mapArrayToString(mServiceData)
...
/**
 *  get from BluetoothUuid.java in API@21
 */
     ...
     */
    private static String sparseArrayToString(SparseArray<byte[]> array) {
        if (array == null) {
            return "null";
        }
        if (array.size() == 0) {
     ...
     */
    private static <T> String mapArrayToString(Map<T, byte[]> map) {
        if (map == null) {
            return "null";
        }
        if (map.isEmpty()) {
